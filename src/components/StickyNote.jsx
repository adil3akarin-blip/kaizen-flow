...
export default function StickyNote({
 ...
 className="absolute -left-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-ink/80 text-xs text-white opacity-0 shadow transition-opacity duration-150 hover:bg-ink group-hover:opacity-100"
 >
 ✎
 </button>
 <button
 ...
 className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-ink/80 text-xs text-white opacity-0 shadow transition-opacity duration-150 hover:bg-ink group-hover:opacity-100"
 >
 ✕
 </button>
 <p
 ...
 className="absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-accent px-2.5 py-0.5 text-[10px] font-medium text-white opacity-0 shadow transition-opacity duration-150 hover:bg-accent-hover group-hover:opacity-100"
 >
 Разобрать
 </button>
 )}
 ...
 onBlur={saveEdit}
 rows={1}
 className="m-0 w-full resize-none overflow-hidden border-none bg-transparent p-0 text-[14px] leading-snug text-ink outline-none"
 />
 )}
 </motion.div>
 </div>
