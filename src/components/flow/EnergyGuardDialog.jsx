      ...
      {open && card && (
        ...
        >
          ...
          >
            ...
            <div className="mt-4 rounded-xl border border-cream-dark/50 bg-cream/30 p-3 opacity-60">
                  ...
                  {alternatives.map((alt) => (
                    <li key={alt.id}>
                      <button
                        ...
                        className="w-full rounded-xl border border-cream-dark/50 bg-white text-left transition-colors hover:bg-cream/50"
                      >
            ...
            <div className="mt-5 flex flex-col gap-2">
              ...
              <button
                ...
                onClick={onCancel}
                className={clsx(
                  'py-2 text-sm text-warm-muted hover:text-warm-text',
