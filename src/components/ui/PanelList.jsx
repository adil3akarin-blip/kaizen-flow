...
export function PanelRow({ children, className, onClick, isLast = false }) {
 ...
 interactive && 'cursor-pointer transition-colors hover:bg-canvas/40',
 className,
 )}
 >
 {children}
 </div>
 {!isLast && <div className="mx-4 border-b border-line/60" />}
 </>
 )
}
...
export function PanelDivider() {
 return <div className="border-b border-line/60" />
}
