...
function CollapseDialog({ onSave, onDiscard, onCancel }) {
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="absolute inset-0 z-10 flex items-center justify-center bg-canvas/80 px-6 backdrop-blur-[2px]"
 >
 <motion.div
...
export default function DumpPanel() {
 ...
 return (
 <aside className="relative flex w-[360px] shrink-0 flex-col border-r border-line bg-canvas">
 ...
 className="flex h-32 w-32 items-center justify-center rounded-full bg-accent text-lg font-medium text-white shadow-lg shadow-accent/30 transition-colors hover:bg-accent-hover"
 >
 Выгрузить
 </motion.button>
 <p className="max-w-[220px] text-center text-sm leading-relaxed text-ink/80">
